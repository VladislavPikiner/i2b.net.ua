$(function() {
    $(".g-form").submit(function(event) {
        ...
        let appLink = "https://script.google.com/macros/s/AKfycbxYWCP8MWYEnuxclTaaK_rVOlm_d0bZWiCyOAcCWVpgWzpZH1raZ5FJ/exec";

        // Сообщение при успешной отправке данных
        let successRespond = alert('Заявка успешно отправленa');
